...
function Hit(props){
    ...
    return(
        ...
        <Card.Footer>
          {props.hit.txId ? <Link target="_blank" href={"https://testnet.bscscan.com/tx/" + props.hit.txId}>See NFT on Ethscan.</Link>: <Link target="_blank" href="https://testnet.bscscan.com/tx/">See NFT on Ethscan.</Link>}
        </Card.Footer>
      </Card>
